...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/deck/2.jpg" title="Deck" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/deck/3.jpg" title="Deck" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
